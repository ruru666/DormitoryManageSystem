...
<script language="JavaScript">
  function mycheck(){
   ...
   if(isNull(form1.Password1.value)){
   alert("请输入重复密码！");
   return false;
   }
      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="studentAction_PasswordUpdate.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                 ...
                 <%--  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Password1" type="password" class="text2" id="Password1"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
