...
<center>
  <table width="900" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="60" bgcolor="#E6F5FF" style="color:#06F; font-size:19px; font-weight:bolder; padding-left:50px;">平顶山学院宿舍管理系统</td>
    </tr>
    <tr>
      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="dormitoryAction_upd" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="33%" height="30" align="right">&nbsp;</td>
                    <td width="67%"><input name="Dormitory.id" type="text" class="noshow" id="Domitory_ID" value="${dormitory.id}"></td>
                  </tr>
                 <%--  <tr>
                  ...
                  <tr> --%>
                    ...
                    <td><input name="Dormitory.num" type="text" class="text2" id="Domitory_Name" value="${dormitory.num}"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>寝室类型：</td>
                    <td><input name="Dormitory.type" type="text" class="text2" id="Domitory_Type" value="${dormitory.type}"></td>
                  </tr>
                  <%-- <tr>
