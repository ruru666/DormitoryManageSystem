      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="buildingAdminAction_UpdPwd" onSubmit="return mycheck()" >
                ...
                <%--   <tr>
                    ...
                    <td><input name="Admin.a_pwd" type="password" class="text2" id="Password">
                  ...
                  <tr>
                    ...
                    <td><input name="buildingAdmin.b_pwd" type="password" class="text2" id="Password2"></td>
                  </tr>
                  <tr>
