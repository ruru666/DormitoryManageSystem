        ...
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="LogAdd.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="67%"><s:property value='student.s_uname'/>
                  ...
                  <tr>
                    ...
                    <td><s:property value='student.s_dormitory'/></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>缺寝日期：</td>
                    <td><label for="Log_Date"></label>
                      <input type="text" name="sr.time" id="Log_Date" class="Wdate" onClick="WdatePicker()"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right">缺寝备注：</td>
                    <td><textarea name="sr.state" id="Log_Remark" cols="45" rows="5"></textarea></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
