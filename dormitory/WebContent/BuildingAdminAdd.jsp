      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="buildingAdminAction_add" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><input name="BuildingAdmin.b_uname" type="text" class="text2" id="Teacher_Username"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>密码：</td>
                    <td><input name="BuildingAdmin.b_pwd" type="password" class="text2" id="Teacher_Password"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>重复密码：</td>
                    <td><input name="Repwd" type="password" class="text2" id="Teacher_Password2"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>姓名：</td>
                    <td><input name="BuildingAdmin.b_name" type="text" class="text2" id="Teacher_Name"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="BuildingAdmin.b_tel" type="text" class="text2" id="Teacher_Tel"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
