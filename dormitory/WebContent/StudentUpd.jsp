      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="studentAction_upd" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="33%" height="30" align="right">&nbsp;</td>
                    <td width="67%"><input name="Student.id" type="text" class="noshow" id="Student_ID" value="${student.id}"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>学号：</td>
                    <td><input name="Student.s_uname" type="text" class="text2" id="Student_Username" value="${student.s_uname}"></td>
                  </tr>
                  <%-- <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Student.s_name" type="text" class="text2" id="Student_Name" value="${student.s_name}"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Student.s_tel" type="text" class="text2" id="Student_Class" value="${student.s_tel}"></td>
                  </tr> 
                  <tr>
                    <td height="30">&nbsp;</td>
